...
public abstract class BaseGraphics extends BaseApps {
        private Color canvasColor = Color.WHITE.brighter();
        protected double canvasW = 1200, canvasH = 700;
    ...
    public void start(Stage stage) throws Exception {     
        ...
        if(stage.getTitle() == null)
            stage.setTitle("A star algoritmo demonstracija ©Lukas Arlauskas, IFF-8/9 KTU IF");                
        super.start(stage);
    }
